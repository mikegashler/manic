...
calibrationIters(0)
{
	...
	encoder.addLayer(new GLayerClassic(observation_dims, hidden, new GActivationBentIdentity()));
	encoder.addLayer(new GLayerClassic(hidden, belief_dims, new GActivationBentIdentity()));
	...
	// Init the decoder
	decoder.addLayer(new GLayerClassic(belief_dims, hidden, new GActivationBentIdentity()));
	decoder.addLayer(new GLayerClassic(hidden, observation_dims, new GActivationBentIdentity()));
